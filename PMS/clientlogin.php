...
<h2 class="text-center"  style="margin-bottom:20px;">CLIENT LOGIN FORM</h2>
</div>
<div class="panel-body">
<form role="form"action="S_chk.php" method="post">

<div class="form-group">
<label><h5>Client ID</h5></label>
<input class="form-control" type="text" name="s_id" required autocomplete="off" />
</div>
<div class="form-group">
