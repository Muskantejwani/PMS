...
<div class="sidebar side">
    <ul class="nav_list">
        ...
        <a href="Employees.php" title="Fees" style="text-decoration:none; list-style:none;">
            ...
            <span class="links_name inactive">AddEmployee</span>
        </a>
        </li>
        <li>
        <a href="allemployee.php" title="Expense" style="text-decoration:none; list-style:none;">
           
            <span class="links_name active">AllEmployee</span>
        </a>
        </li>
...
<!--position:relative;  top: -100%; margin-bottom:45%;   margin-left:10%; margin-left:10%; padding-right:5%;-->

 <!--   <div class="container bg" >
        <div class="row" style="width:70%; position:relative;">-->
            <div class="col-md-10 col-sm-12" >
                <br>
               
                 <table class="table" id="myTable" style="position:relative; right:2%;"> 
                 <input type="text" name="search" id="search"  onkeyup="search_table();  " placeholder="search by employee Name" class="form-control"
...
foreach($result as $row){
    ?>
               ...
               <td class="d-flex pt-3"> <a href="edit-employee.php?f_id=<?php echo $row['f_id']?>">
