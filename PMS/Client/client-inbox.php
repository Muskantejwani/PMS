...
<center  class="bg">
<div class="col"  style="position:relative;  top: -100%; margin-bottom:41%;  margin-left:23%; margin-right:2%;">

				<div class="row mx-auto mid">
     
                            <table class="table table-hover"width="40%" cellpadding="05" cellspacing="01" border="0" align="center" bgcolor="red"  >  
                            <?php
                                        echo "<br/>";
                                        echo "<br/>";
                                        echo "<br/>";
