...
<table  width="100%" cellspacing="00" cellpadding="00">
  ...
  <th><button type="button" class="btn btn-dark hello" style="margin: 1% 2%; padding: 2% 6%;  font-size:18px; border-radius:10px;"><a href="Employee.php" style="color:white; text-decoration:none; list-style:none;">Back</a></button></th>
    ...
    <table class="table table-hover" id="myTable" border=" 0" align="center" bgcolor="black" style="font-size:16px;">
            <?php
                ...
                include 'connection.php';
                      ...
                      $sql1="select * from meeting where  meeting.f_id = $user;";
